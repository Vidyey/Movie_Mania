...
class MovieManiaTesting {
	...
	void setup() {
		...
		movieService.registerCustomer(new Customer(1111112, "mahesh123","pet name", "maddy", "Mahesh", "21-09-1998", "8765677766"));
		System.out.println();
	...
	public void registrationFirstTest() throws Exception {
		String message = movieService.registerCustomer(new Customer(1111121, "pratik123","pet name", "tom", "Pratik", "21-09-1998", "8765677766"));
	...
	public void registrationSecondTest() throws Exception {
		String message = movieService.registerCustomer(new Customer(111111, "pratik123","pet name", "tom", "Pratik", "21-09-1998", "8765677766"));
	...
	public void loginFirstTest() throws Exception {
		...
		boolean result = movieService.custLogin(1111112, "mahesh123");
	...
	public void loginSecondTest() throws Exception {
		boolean result = movieService.custLogin(111111, "pratik1232");
	...
	public void changePasswordFirstTest() throws Exception {
		String message = movieService.changePassword(1111112, "mahesh123", "mahesh12345");
	...
	public void changePasswordSecondTest() throws Exception {
		String message = movieService.changePassword(1111112, "mahesh1233", "mahesh123");
	...
	public void forgotPasswordFirstTest() throws Exception {
		String message = movieService.forgotPassword(1111112, "pet name", "maddy");
	...
	public void forgotPasswordSecondTest() throws Exception {
		String message = movieService.forgotPassword(1111112, "first car", "maddy");
